...
import { ShoppingCart, Package, Phone, MapPin, Clock, CheckCircle, X } from 'lucide-react';
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-muted-foreground text-center">
              Orders from buyers will appear here when they purchase your products
            </p>
          </CardContent>
        </Card>
      ) : (
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mb-1">
                      <strong>Name:</strong> {order.buyer_profile.full_name}
                    </p>
                ...
                <div className="flex gap-2">
                  ...
                  {order.buyer_profile.phone_number && (
                    <Button
                      variant="outline"
                      onClick={() => window.open(`tel:${order.buyer_profile.phone_number}`)}
                      className="flex items-center gap-2"
                    >
