...
export default function FarmerBlogs() {
      ...
      const mockBlogs: BlogPost[] = [
        {
          ...
          content: 'Learn about sustainable farming techniques...',
          status: 'published',
        ...
        },
        {
          ...
          content: 'How to plan your crops for maximum yield...',
          status: 'draft',
    ...
    <div className="container mx-auto p-6 max-w-6xl">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage your farming knowledge articles</p>
        </div>
        <Button onClick={() => navigate('/farmer/blogs/create')} className="flex items-center gap-2">
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              <div className="text-center">
                ...
                <Button onClick={() => navigate('/farmer/blogs/create')}>
