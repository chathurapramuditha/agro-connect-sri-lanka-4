...
export default function BuyerBlogCreate() {
    ...
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">Share your produce buying experiences</p>
        </div>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select value={category} onValueChange={setCategory}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="farmer-experience">Farmer Experience</SelectItem>
                    <SelectItem value="cooking-tips">Cooking Tips</SelectItem>
                    <SelectItem value="nutrition">Nutrition</SelectItem>
                    <SelectItem value="seasonal-produce">Seasonal Produce</SelectItem>
            ...
            <div className="space-y-2">
              ...
              <Input
                id="tags"
                placeholder="Enter tags separated by commas (e.g., organic, fresh, local, seasonal)"
                value={tags}
