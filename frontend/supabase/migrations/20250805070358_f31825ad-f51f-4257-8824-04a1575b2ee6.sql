...
-- First drop all existing RLS policies that depend on the columns
...
-- Update the conversations table structure and data
...
-- Recreate RLS policies for conversations using user_id
...
-- Recreate RLS policies for messages using user_id
